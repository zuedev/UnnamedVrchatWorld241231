    ...
    public class TC_TerrainAreaEditor : Editor
    {
        ...
        public void DrawTerrain(int index, float space)
        {
            ...
            if (terrainArea.settingsTab)
            {
                ...
                EditorGUILayout.BeginHorizontal();
                GUILayout.Space(60 + space);
                EditorGUILayout.LabelField("Grass Scatter", GUILayout.Width(147.0f));
                currentTerrain.detailScatterMode = (DetailScatterMode)EditorGUILayout.EnumPopup(currentTerrain.detailScatterMode);
                EditorGUILayout.EndHorizontal();
#endif
            ...
            if (terrainArea.grassTab)
            {
                ...
                for (int countGrass = 0; countGrass < currentTerrain.detailPrototypes.Count; ++countGrass)
                {
                    ...
                    if (currentTerrain.detailSettingsFoldout)
                    {
...
#if UNITY_5 || UNITY_2017 || UNITY_2018 || UNITY_2019 || UNITY_2021_1
                        if (!currentTerrain.detailPrototypes[countGrass].usePrototypeMesh)
                        {
                            EditorGUILayout.BeginHorizontal();
                            GUILayout.Space(70 + space);
                        ...
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Space(70 + space);
                        currentTerrain.detailPrototypes[countGrass].density = EditorGUILayout.Slider("Coverage Mode Density", currentTerrain.detailPrototypes[countGrass].density, 0f, 5f);
                        EditorGUILayout.EndHorizontal();
#endif
